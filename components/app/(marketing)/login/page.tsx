...
function LoginForm() {
  ...
  const { setUser, setSession, setProfile, setSubscription, setIsPremium } = useAuthStore();
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8 backdrop-blur-sm">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-white/50 mt-1">
              {mode === 'login' ? 'Sign in to your XCrypt account' : 'Get started with XCrypt'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white border-0 hover:opacity-90"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#0F1420] text-white/30">or</span>
            </div>
          </div>
